    ...
    const sections = [
        ...
        },
        {
            ...
            links: [
                ...
                { name: "AEO Grader", href: "/aeo-grader", description: "Get a quick AEO score benchmark for AI search visibility." },
                ...
                { name: "Sample AEO Report", href: "/sample-aeo-report", description: "See what a strong answer engine optimization report includes." },
                { name: "AEO Checker vs Grader", href: "/aeo-checker-vs-aeo-grader", description: "Compare a quick AEO grader with a full AEO checker audit." },
                { name: "Improve AEO Score", href: "/how-to-improve-aeo-score", description: "Learn the highest-impact ways to improve your AEO score." },
                { name: "AI SEO Checker", href: "/ai-seo-checker", description: "Audit your site for AI SEO and answer engine visibility." },
