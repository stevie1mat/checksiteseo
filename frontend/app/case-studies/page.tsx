...
export const metadata: Metadata = createPageMetadata({
    title: "AEO Case Studies & Results",
    description: "Explore AEO case studies showing how teams improved AI search visibility, citations, and qualified traffic.",
    path: "/case-studies",
    keywords: ["AEO case studies", "AI search case study", "answer engine optimization results"],
});
