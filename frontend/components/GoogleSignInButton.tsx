...
export function GoogleSignInButton({ mode = "signin", className, text }: GoogleSignInButtonProps) {
    ...
    const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            // Note: No need to stop loading or track completion here as the page will redirect
